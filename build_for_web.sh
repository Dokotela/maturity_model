...
projectId="chop-361220"
projectName="maturity-model-institution"
...
cd $localProject && flutter build web --web-renderer canvaskit --release --dart-define APP_NAME="Maturity Model Institution" --dart-define APP_SUFFIX=.dev && cd ..
