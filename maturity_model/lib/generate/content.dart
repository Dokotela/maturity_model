            ...
            "groups": [
                {
                    ...
                    "level2": "Health data is sometimes obtained from few sources, largely using paper-based methods, although a few simple electronic tools like spreadsheets may be used for some data sources. Data frequently has limited utility because of quality issues. Some indicators definitions are defined but not easily accessible/shared.",
                    "level3": "Health data are routinely from key data sources. Data is collected electronically using a variety of tools like spreadsheets, databases and client-based information systems. Integration from different sources is often a manual process, and may be constrained by comparability issues.",
                    "level4": "Health data is derived routinely and timely from all key data sources. The institution carries out proactive activities to improve data collection processes. Some data is available in near-real time to support decision-making.",
                    ...
                    "items": [
                        {
                            ...
                            "level2": "identified and needs often change based on individual decisions",
                            "level3": "data needs are being defined based on entity needs and on accessible methodology (rational) for data needs that ensures sustainability",
                            "level4": "data needs are being defined based on entity needs and on accessible methodology (rational for each indicator) for data needs that ensure sustainability, flexible to include new information needs, mechanism in place to ensure that overlapping data needs are harmonized within institution",
                            "level5": "identified and continously efficiently adapting to new needs, flexible and harmonized",
                        ...
                        },
                        {
                            ...
                            "level1": "not defined",
                            "level2": "identified and needs often change based on individual decisions",
                            "level3": "data sources are being defined based on entity needs that mostly allows data comparability",
                            "level4": "data sources are being defined based on entity needs that ensures comparability",
                            "level5": "defined and continously efficiently adopting to new sources incl. unstructured data and ensuring comparability",
                            "runtimeType": "question"
                        },
                        {
                            "text": "A institutional data updating schedule is being defined and shared",
                            ...
                            "level5": "Update schedule defined and shared with organization and countries",
                            "runtimeType": "question"
                        },
                        {
                            "text": "For indicators, identify how often data is collected and updated.",
                            "questions": [],
                        ...
                        {
                            "text": "For indicators, identify how is data collected (format):",
                            "questions": [],
                            "runtimeType": "subGroup"
                        },
                        {
                            ...
                            "level3": "Some data is collected electronically, mostly using databases or other electronic client-based information systems. Data integration from various sites is done manually.",
                            ...
                            "level5": "All data is collected and data sets are integrated across multiple sources (e.g. across different data sources or different institutions, or sub-institutional and institutional levels). All relevant data is available in real or near-real time for decision-making (e.g. dashboards).",
                            "runtimeType": "question"
                        },
                        {
                            "text": "Health Related Sustainable Development Goals",
                        ...
                        {
                            "text": "For indicators, disaggregation is available for the following variables (as dimensions for equity measurement):",
                            "level1": "Not collected",
                            "level2": "Sex, age",
                            "level3": "Sex, age, subnational level",
                            "level4": "Age by birth date, sex, subnational level, income level, education level",
                            "level5": "Age by birth date, sex, income level, education level and other equity characteristics relevant to country (e.g. ethnicity, migration status, disability, sexual identity, etc.) at lowest admin level",
                            "runtimeType": "question"
                        },
                        {
                            "text": "Regional Core Indicators",
                        ...
                        },
                        {
                            ...
                            "level2": "Sex, age",
                            "level3": "Sex, age, subnational level",
                            "level4": "Age by birth date, sex, subnational level, location, income level, education level",
                            "level5": "Age by birth date, sex, income level, education level and other equity characteristics relevant to country (e.g. ethnicity, migration status, disability, sexual identity, etc.) at lowest admin level",
                            "runtimeType": "question"
                        },
                        {
                        ...
                        {
                            "text": "Data quality (completeness, consistency, accuracy, timeliness, interpretability) for programmatic indicators:",
                            "questions": [],
                            "runtimeType": "subGroup"
                        },
                        {
                            ...
                            "level2": "Data is collected, but often not used due to completeness, consistency and accuracy problems.",
                            "level3": "There are known completeness and accuracy problems for some data elements. Data from different sources are often not comparable due to quality issues.",
                            "level4": "Data is generally complete, consistent and accurate for all data elements for at least 10 years. Biases/issues are known and analyses can be accordingly adjusted. Data is comparable across sources and time.",
                            "level5": "Data is reliable, complete and accurate for at least 20 years.",
                            "runtimeType": "question"
                        },
                        {
                            "text": "Health Related Sustainable Development Goals",
                ...
                },
                {
                    ...
                    "subTitle": "Health data that are processed and published openly in a variety of formats that accomplish the different needs of IS4H constituencies.",
                    "level1": "Information products and specifically health related indicators are generally not shared. The institution relies heavily on estimates from other institutions.",
                    "level2": "Some information products are generated, but not routinely, and require intensive work and use of resources. Data is not readily shared across units, with stakeholders or public. Sharing data frequently requires permission from senior levels.",
                    "level3": "A range of information products are efficiently and routinely produced from varies entities' information systems that may complement each other. Dissemination of information products is typically limited to senior-level decision makers.",
                    ...
                    "items": [
                        {
                            "text": "Information products (Information products are: bulletins, briefings, newsletters, technical reports, article, online shared database, infographics, fact sheets…Information products are not travel reports, presentations,.)",
                            "level1": "no products",
                            ...
                            "level5": "a variety of information products are regularly produced and shared real time or/and upon receiving",
                            "runtimeType": "question"
                        },
                        {
                        ...
                        },
                        {
                            ...
                            "level4": "Disseminated to stakeholders throughout the organization",
                        ...
                        },
                        {
                            ...
                            "level3": "An institutional platform exists and updated infrequently and with limited content of health data",
                            "level4": "An institutional platform is updated frequently, timely with extensive coverage of health data",
                            "level5": "A well documented institutional platform is updated frequently with full coverage of health data, dissaggregeted data, and open access",
                            "runtimeType": "question"
                        },
                        {
                ...
                },
                {
                    ...
                    "subTitle": "Use and availability of data standards, identifiers, standards for interoperability and institutional health information architecture",
                    "level1": "There are few, if any, formal data standards enforced.",
                    "level2": "Some standards are defined in individual data sources but are not consistent or available across data sources and/or entities. Standards for interoperability have been identified but not implemented.",
                    "level3": "Some standards have been identified for specific data sources, and there are formal plans for adoption.",
                    "level4": "Standards have been formally adopted and the institutional health information architecture has been documented. An institutional identifier is available for integrating health data form all sources.",
                    "level5": "Information systems for health are interoperable, enabled by a institutional infrastructure that uses international standards, technologies and architectures.",
                    "items": [
                        {
                            "text": "Communication and data exchange standards and other that may apply (eg security, information, quality)",
                            "level1": "No awareness or plans to adopt",
                            "level2": "There is general awareness of the standards, but no plans to adopt.",
                            "level3": "Identified as a standard, with a formal plan for adoption",
                            "level4": "Formally defined and adopted institutionally.",
                            "level5": "Fully implemented institutionally",
                            "runtimeType": "question"
                        },
                        {
                            "text": "IT Competencies for standards including data standards (WHO FIC, LOINC, CPT,..) messaging standards (HL7, FHIR, DICOM), and content standards (CDA) relevant to technical work area.",
                            "level1": "No awareness",
                            "level2": "There is general awareness of the standards, but no technical competencies",
                            "level3": "There is general awareness of the standards, and beginner technical competencies",
                        ...
                        {
                            "text": "A set of institutional agreed-upon health indicator and a corresponding compendium exists (definitions including technical specifications)",
                            "questions": [],
                            "runtimeType": "subGroup"
                        },
                        {
                        ...
                        {
                            "text": "There is a institutional health information architecture",
                            "level1": "None",
                            ...
                            "level4": "Data sources, data flows, data repositories, messaging and data standards documented and partially implemented within the institutional health system",
                            "level5": "Institutional health information architecture fully implemented",
                            "runtimeType": "question"
                        }
                    ]
                },
                {
                    ...
                    "subTitle": "Health data governance is the framework for establishing institutional, objectives, policies, standards, and tools for the management of technical data, which is supported by a legal framework.",
                    "level1": "There are a few if any best practices for data management implemented. Data management is largely ad hoc. There are no formal mechanisms for decisions about data quality and standards.",
                    "level2": "Data management best practices are in development, but not fully implemented. Data quality is not routinely monitored. Decision about standards quality and standards are made at individual level.",
                    "level3": "Data management processes and best practices are implemented for some units/teams. (e.g. Data quality frameworks, data standards, policies, SOPs,…) Core data sets are readily available. Data are often integrated for analysis across various sources. Some metadata are documented and maintained (indicator compendium, data dictionaries). A data governance body within the institutional health authority exists.",
                    "level4": "A formal health data governance mechanisms has been established at the institutional level with other health data stakeholders, and there are processes and plan in place to strengthen alignment of standards, data quality frameworks and data management practices across all stakeholders.",
                    ...
                    "items": [
                        {
                            ...
                            "level3": "The institutional health authority has established a formal body for making decisions about data",
                            "level4": "There is a institutional body that makes decisions about health data that meets and works across sectors including part of private sector",
                            "level5": "There is a institutional body that make decisions about data and that functions and works across sectors including the private sector",
                            "runtimeType": "question"
                        },
                        {
                            "text": "There is an institutional data and governance policy in place",
                            "level1": "No awareness or plans to adopt a policy",
                            "level2": "There is general awareness of the policy, but no plans to adopt",
                        ...
                        },
                        {
                            ...
                            "level1": "No framework",
                            "level2": "Some teams/units/departments work on data quality based on individual initiatives but no data quality framework exists",
                            "level3": "Some units/teams/departments work on data quality and a data quality framework is in progress",
                            "level4": "Some units/teams/departments work on data quality based on a developed data quality framework",
                            "level5": "There is a data quality framework that is aligned and fully implemented at the institutional level.",
                            "runtimeType": "question"
                        },
                        {
                        ...
                        },
                        {
                            "text": "Regional Core Indicators",
                            "level1": "No",
                            "level2": "Defined for teams/units/departments, but not formally implemented",
                            "level3": "Fully implemented in some teams/units/departments",
                            "level4": "Implemented and aligned across most teams/units/departments",
                        ...
                        {
                            "text": "For programmatic indicators, identify how data quality is monitored.",
                            "questions": [],
                            "runtimeType": "subGroup"
                        },
                        {
                ...
                },
                {
                    ...
                    "subTitle": "Availability and maintenance of Tools, Networks, Hardware and Software to support IS4H. Interoperability among platforms and integration of data repositories.",
                    ...
                    "level4": "Widely available and interoperable across the institution.",
                    "level5": "There is significant interoperability across health platforms. Integrated institutional repositories from multiple data sources.",
                    "items": [
                        {
                            "text": "There is an Information Technology governance body in place to supervise ICT standards",
                            "level1": "ICT performance",
                            "level2": "policies and to coordinate investments.",
                            "level3": "There are no formal mechanism for making decisions about IT.",
                            "level4": "Decision about IT are made within the team/unit/department.",
                            "level5": "The institutional health authority has established a formal body for making decisions about IT.",
                            "runtimeType": "question"
                        },
                        {
                        ...
                        },
                        {
                            ...
                            "level5": "Interoperability within the institution and fully functional and continuoulsy improved",
                            "runtimeType": "question"
                        },
                        {
                            "text": "Health Related Sustainable Development Goals",
                        ...
                        {
                            "text": "There are defined policies and SOPs for IT management for each information system",
                            "level1": "Not available",
                            "level2": "in planning",
                            "level3": "draft exists",
                            "level4": "SOP exists",
            ...
            "groups": [
                {
                    ...
                    "level1": "Accountability and decision-making for IS4H components is distributed across different units within institutional authorities, and investments and activities are not coordinated.",
                    "level2": "IS4H investment decisions are coordinated at the management level within individual authorities but not formally coordinated among other institutional entities.",
                    "level3": "There is a formal governance structure in place for strategic planning and oversight of IS4H among the institutional entities",
                    "level4": "IS4H governance structures are established at the institutional level across at least some key national stakeholders (e.g. health authorities, national IT authorities, vital Statistics, national statistics authorities)",
                    "level5": "The governance and management of IS4H is fully transparent and integrated across all national stakeholder institutions.",
                    "items": [
                        {
                            "text": "Roles and functions of key institutional actors are formally documented and mapped.",
                            "level1": "No mapping or documentation exist. Knowledge of roles and functions of information system actors resides in individuals.",
                            "level2": "Individual entities have mapped the roles and functions of some key roles but not shared at the institutional level.",
                            "level3": "There is a formal roster of instititutional information system actors documented and available.",
                            "level4": "There is a formal roster of institutional information system actors with a mapping of roles and relationships.",
                            "level5": "Health information system functions, roles and responsibilities are mapped, integrated and aligned across institution.",
                            "runtimeType": "question"
                        },
                        {
                            "text": "Decisions mechanisms for IS4H strategic priorities, investments and technical approaches.",
                            "level1": "Decision for IS4H are only addressed at the unit level",
                            "level2": "There is no formal governance structure within the institution, but IS4H issues are routinely discussed within the Institution's executive leadership body.",
                            "level3": "There is a formal IS4H governance structure within the institution in adoption.",
                            "level4": "There is an institutional governance structure with key institutional managerial stakeholders implemented in most entities.",
                            "level5": "The institutional governance structure is fully integrated with the IS4H governance structure in entire the institution.",
                            "runtimeType": "question"
                        }
                    ]
                },
                {
                    ...
                    "subTitle": "Addressing IS4H under policies, strategies and SOPs at the institutional level. Mechanisms for developing or adopting an IS4H governance strategy or policy that promotes a better decision- and informed policy-making mechanisms.",
                    "level1": "There is no current Institutional Strategic IS4H Plan and IS4H components are not reflected in operational plans.",
                    "level2": "There is a institutional Strategic IS4H Plan, but it does not address IS4H. Some individual teams/units/departments include some components of IS4H in their operational plans.",
                    "level3": "There is a current institutional Strategic IS4H Plan that includes priorities for strengthening health information. IS4H is included within operational plans of institution",
                    "level4": "There is a formal strategic plan in place among institutional authorities for strengthening IS4H that reflects the IS4H Strategic Framework. Operational plans of the units/departments within institution reflect IS4H activities and outcomes based on the IS4H Strategic Plan.",
                    "level5": "There is an institutional Strategic IS4H Plan, and operational plans are aligned and integrated across multisectoral stakeholders.",
                    "items": [
                        {
                            "text": "There is an institutional IS4H Strategic Plan.",
                            "level1": "There is no current Institutional Strategic IS4H Plan.",
                            "level2": "There is a current Institutional Strategic IS4H Plan, but it does not address components of IS4H.",
                            "level3": "There is a current Institutional Strategic IS4H Plan that includes a priority for strengthening health information that reflects two or more strategic domains within the IS4H framework.",
                            "level4": "There is a formal strategic plan in place among institutional authorities for strengthening IS4H that reflects all of the domains in the IS4H Strategic Framework",
                            "level5": "There is a comprehensive Institutional Strategic IS4H Plan that includes strategic goals and initiatives from multi-sectoral partners.",
                            "runtimeType": "question"
                        },
                        {
                            "text": "There is an institutional IS4H operational plan.",
                            "level1": "IS4H components are not reflected in operational plans.",
                            "level2": "Some teams/units/departments are are developing their operational plans to include IS4H components .",
                            "level3": "IS4H is specifically included within the operational plan of some teams/units/departments",
                            "level4": "IS4H is specifically included within the operational plan of most teams/units/departments",
                            "level5": "IS4H operational is fully aligned with Institutional IS4H Strategic Plan of the Institution.",
                            "runtimeType": "question"
                        }
                    ]
                },
                {
                    ...
                    "subTitle": "institutional structure & information flows of health-related institutions, roles and responsibilities of IS4H actors.",
                    "level1": "Some IS4H functions are formally defined and performed, but there are significant gaps",
                    "level2": "There are gaps in IS4H services or functions, and/or services and functions may be duplicated across teams/units/departments.",
                    "level3": "Accountability and responsibility for IS4H functions within institution have been defined, and there are plans in place for institutional restructuring or re-alignment to rationalize functions and decision-making.",
                    "level4": "An institutional structure that defines clear accountabilities and responsibilities for IS4H has been fully implemented within institution, and is reflected in unit/program mandates and job descriptions.",
                    "level5": "IS4H functions are defined, performed and aligned across stakeholders. Functions are integrated across stakeholders, optimizing performance, value and investments at the institutional level.",
                    "items": [
                        {
                            "text": "There is a documented and formally adopted structure (organigram) for the institution.",
                            "level1": "No formal institutional structure is defined.",
                            "level2": "Yes, but the institutional structure has not yet been formally approved or published.",
                            ...
                            "level5": "Yes, with IS4H fully reflected and aligned with institutional structures across multisectoral partners.",
                            "runtimeType": "question"
                        },
                        {
                            "text": "The overall leadership and accountability for IS4H is defined.",
                            "level1": "IS4H responsibility is not currently defined and there is no clear leadership for IS4H.",
                            "level2": "Responsibility for IS4H is defined within institution for teams/units/departments, but there is no clear leadership for IS4H.",
                            "level3": "Leadership for IS4H is defined, and there are formal plans for institutional re-structuring to clearly define roles and responsibilities within the institution.",
                            "level4": "Responsibility for IS4H is defined and integrated in the institution, and leadership is well defined.",
                        ...
                        },
                        {
                            ...
                            "level2": "There is awareness of principles, but no institutional capacity to implement change management methodologies",
                            "level3": "Some capacity for change management but lack institutional resources",
                            "level4": "There is a formal and efficient change management program unit or team.",
                        ...
                        },
                        {
                            ...
                            "level2": "Most functions are performed but not formally defined, and/or there are overlapping accountabilities or duplication of efforts.",
                            "level3": "Functions are defined, and there are plans to address gaps and to align accountabilities.",
                            "level4": "Functions are fully defined and accountabilities are aligned within the institution",
                            "level5": "Functions are fully defined and accountabilities are aligned across multisectoral partners",
                            "runtimeType": "question"
                        },
                        {
                        ...
                        },
                        {
                            ...
                            "level2": "There are some policies/SOPs defined to guide IS4H activities and processes, but many are out of date, or not formally adopted within the institution",
                            "level3": "Specific gaps in policies/SOPs have been identified, and there are plans in progress to update and adopt policies/SOPs within the institution",
                            "level4": "Policies/SOPs are well defined and formally adopted to guide IS4H activities and processes within the institution",
                            "level5": "Policies/SOPs are to guide IS4H activities and processes, and are integrated and aligned across multisectoral stakeholders.",
                            "runtimeType": "question"
                        },
                        {
                            "text": "Information Management and Analysis",
                            ...
                            "level3": "Specific gaps in policies/SOPs have been identified, and there are plans in progress to update and adopt policies/SOPs within the institution",
                            "level4": "Policies/SOPs are well defined and formally adopted to guide IS4H activities and processes within the institution",
                            "level5": "Policies/SOPs are to guide IS4H activities and processes, and are integrated and aligned across multi-sectoral stakeholders.",
                            "runtimeType": "question"
                        },
                        {
                            "text": "Health Informatics",
                            "level1": "There are few, if any, policies/SOPs defined to guide the activities and processes across IS4H domains.",
                            "level2": "There are some policies/SOPs defined to guide IS4H activities and processes, but many are out of date, or not formally adopted within institution",
                            "level3": "Specific gaps in policies/SOPs have been identified, and there are plans in progress to update and adopt policies/SOPs within institution",
                            "level4": "Policies/SOPs are well defined and formally adopted to guide IS4H activities and processes within the institution",
                            "level5": "Policies/SOPs are to guide IS4H activities and processes, and are integrated and aligned across multi-sectoral stakeholders.",
                            "runtimeType": "question"
                        },
                ...
                },
                {
                    ...
                    "subTitle": "Budget for IS4H implementation, sustainability, investment. Resources mobilization plans and ERP systems.",
                    "level1": "IS4H activities/resources are not formally identified in unit/department budgets. While it is sometimes possible to secure one-time financial resources for IS4H investments, required investments are difficult to sustain.",
                    "level2": "IS4H activities are identified in unit/department annual budgets of institution, but are not integrated or aligned across units/departments. The financial resources requirements to effectively sustain IS4H have been identified, but there is no plan to address gaps.",
                    "level3": "There is a plan in place for resource mobilization for specific IS4H capital investments. Financial resources secured for the sustainable implementation. Operations of IS4H have been secured with annual budgets.",
                    "level4": "An IS4H investment framework is established at the institutional level.",
                    ...
                    "items": [
                        {
                            ...
                            "level4": "There is an IS4H investment framework at the institutional level that identifies financial resource requirements and investment sources.",
                        ...
                        },
                        {
                            ...
                            "level3": "Units/departments have line-items for some IS4H components in their budgets, but it is not possible to roll-up these budgets at the institutional level.",
                            "level4": "There are specific budget line-items for IS4H components that are consistent across units/departments and that can be rolled up across the institution",
                            "level5": "There are specific budget line-items for IS4H components that are consistent across multi-sectoral stakeholders that can be rolled up at the institutional level.",
                            "runtimeType": "question"
                        }
                    ]
                },
                {
                    ...
                    "subTitle": "Human capital for planning, implementing, and managing IS4H. Competency building activities to strengthen to IS4H skills. Job functions identified to effectively support IS4H.",
                    ...
                    "level5": "There is a institutional strategy for building IS4H human resource competencies that includes international educational institutions to ensure the long term availability of skilled IS4H resources.",
                    "items": [
                        {
                        ...
                        },
                        {
                            ...
                            "level5": "There is a institutional IS4H human resource strategy in place aligned with multisectoral partners.",
                            "runtimeType": "question"
                        },
                        {
                            "text": "Information Management and Analysis",
                            ...
                            "level3": "There are short-term plans in place to address human resource gaps.",
                            "level4": "There is a long-term IS4H human resources strategy in place that reflects the overall IS4H strategic priorities.",
                            "level5": "There is an institutional IS4H human resource strategy in place aligned with multisectoral partners.",
                            "runtimeType": "question"
                        },
                        {
                            "text": "Health Informatics",
                        ...
                        {
                            "text": "Leadership and staff have knowledge of key IS4H concepts to effectively plan, implement and support IS4H across the entire institutions.",
                            "questions": [],
                            "runtimeType": "subGroup"
                        },
                        {
                        ...
                        {
                            "text": "There is capacity within the institution to educate, train and strengthen the IS4H workforce:",
                            "questions": [],
                            "runtimeType": "subGroup"
                        },
                        {
                            "text": "Information Technology Management",
                            "level1": "There is no institutional capacity to educate and train human resources.",
                            "level2": "There is some technical training capacity in the institution.",
                            "level3": "There is adequate technical training capacity in the institution.",
                            "level4": "There is technical training capacity in the institution in collaboration with academia",
                            "level5": "There is technical and managerial training capacity in the institution in collaboration with academia, continous and high quality level education for all levels (junior, mid- and senior level)",
                            "runtimeType": "question"
                        },
                        {
                            "text": "Information Management and Analysis",
                            ...
                            "level2": "There is some technical training capacity in the institution.",
                            "level3": "There is adequate technical training capacity in the institution.",
                            "level4": "There is technical training capacity in the institution provided with external resources.",
                            "level5": "There is technical and managerial training capacity in the institution in collaboration with academia, continous and high quality level education for all levels (junior, mid- and senior level)",
                            "runtimeType": "question"
                        },
                        {
                ...
                },
                {
                    ...
                    "subTitle": "Relations with public and private key stakeholders at institutional and interinstitutional level.",
                    "level1": "Identified key stakeholders are from the public health sector exclusively.",
                    "level2": "There are some relationships with other public sector stakeholder for specific some information and service needs. However, engagement and coordination is ad hoc.",
                    "level3": "Informal relationships have been established with key multisectoral national actors, including private sector institutions.",
                    "level4": "Formal relationships have been established with multisectoral actors, including the private sector. There are examples are collaborative initiatives between multisector partners.",
                    "level5": "IS4H governance includes representation from multi-sectoral partners. IS4H roles, responsibilities and functions are aligned across multisectoral partners.",
                    "items": [
                        {
                        ...
                        },
                        {
                            ...
                            "level5": "Institutional IS4H governance structure provides formal arrangements for the sharing of information across multisectoral partners.",
                            "runtimeType": "question"
                        },
                        {
                            "text": "Economy",
                        ...
                        },
                        {
                            ...
                            "level5": "Institutional IS4H governance structure provides formal arrangements for the sharing of information across private sector partners.",
                            "runtimeType": "question"
                        },
                        {
                            "text": "There are established relationships with international institutions and NGOs for information sharing and coordination.",
                            "level1": "No relationships with international institutions/NGO stakeholders.",
                            "level2": "Information sharing with international/NGO stakeholders is ad hoc, for some specific information needs.",
                            "level3": "Information sharing with international institutions/NGO stakeholders happens routinely, but not based on a formal agreement.",
                            "level4": "There are specific formal agreements for information sharing with international/NGO stakeholders.",
                            "level5": "Institutional IS4H governance structure provides formal arrangements for the sharing of information across international/NGO partners.",
                            "runtimeType": "question"
                        }
                    ]
                },
                {
                    ...
                    "subTitle": "Key and core legislation, policy and compliance mechanisms, elements to enable IS4H implementation, operation and maintenance.",
                    ...
                    "items": [
                        ...
                        },
                        {
                            ...
                            "level3": "Some teams/units/departments have polices as part of their institutional policy framework.",
                            "level4": "There are policies at the institutional level for the public health sector.",
                            "level5": "There are policies at the institutional level that apply to all multisectoral stakeholders.",
                            "runtimeType": "question"
                        },
                        {
                ...
                },
                {
                    ...
                    "subTitle": "National and International agreements to contextualize strategic planning and investments. Commitment to regional and global mandates.",
                    "level1": "There is some awareness of data and reporting obligations under interinstitutional and international agreements, but little capacity to meet obligations.",
                    "level2": "Data and reporting obligations under interinstitutional and international agreements are frequently met, but with high resource impact.",
                    "level3": "Data and reporting obligations under interinstitutional and international agreements are consistently met with an effective use of resources.",
                    "level4": "Agreements enable data and information sharing across interinstitutional and international stakeholders.",
                    "level5": "Data and information are able to flow freely among interinstitutional and international partners in support of agreements, guided by frameworks that ensure the ethical use of information that protects individuals and populations.",
                    "items": [
                        {
                            "text": "Capacity to meet data and reporting obligations under interinstitutional and international agreements.",
                            "questions": [],
                            "runtimeType": "subGroup"
                        },
                        {
                            ...
                            "level3": "There is sufficient capacity to meet interinstitutional data and reporting obligations with an effective use of resources.",
                            "level4": "There is sufficient capacity to meet interinstitutional and international data and reporting obligations with an effective use of resources.",
                            "level5": "Systems, process and agreements allow data to flow freely between interinstitutional and international partners.",
                            "runtimeType": "question"
                        },
                        {
                            "text": "SDG´s",
                        ...
                        },
                        {
                            ...
                            "level2": "There is some data sharing among stakeholders, but data sharing requirements new agreements or approvals each time.",
                            "level3": "Data can be shared routinely among stakeholders, which contributes to capacity to meeting international data and reporting obligations.",
                            "level4": "Data can be shared routinely among international stakeholders, which contributes to capacity to meeting international data and reporting obligations.",
                            "level5": "Data is able to flow freely among countries'and international partners guided by frameworks that ensure the ethical use of information that protects individuals and populations.",
                            "runtimeType": "question"
                        }
                    ]
                }
            ...
            "groups": [
                {
                    ...
                    "subTitle": "Knowledge management methodologies and mechanisms to improve decision-making, capture, share and measure institutional knowledge.",
                    "level1": "Knowledge sharing in the institution is ad hoc and institutional knowledge resides with key individuals rather that on repeatable processes documented in unit descriptions, job descriptions, policies and SOPs.",
                    "level2": "There are some basic knowledge management mechanism and processes (e.g. formal meeting notes, trip reports, SOPs, documentation etc.) in place but not always accessible and updated and are not required in policy or practice.",
                    "level3": "There are numerous knowledge management processes defined (lessons learned, trip reports, mentoring, shadowing, etc.) guided by formal policies and procedures. :There is a formal basic KM strategy at the institutional level",
                    "level4": "Knowledge management sharing is integrated into business processes, job descriptions and institutional functions. Metrics are used to quantitatively measure institutional knowledge management processes and capacities, and continuously improve performance.",
                    "level5": "Health authorities and their multisectoral partners are fully learning organizations: The institutional culture encourages the free-flow of knowledge throughout the organization, enabled by KM processes, tools and technology.",
                    "items": [
                        {
                        ...
                        },
                        {
                            ...
                            "level3": "Metrics are used to quantitatively measure institutional knowledge management processes and capacities",
                        ...
                        },
                        {
                            ...
                            "level3": "Some teams/units/departments do as part of their institutional processes",
                        ...
                        },
                        {
                            ...
                            "level1": "Not existent",
                            "level2": "Practiced ad hoc as an individual initiative",
                            "level3": "Some teams/units/departments are developing a program, currently informal initiatives",
                        ...
                        },
                        {
                            ...
                            "level1": "No",
                            "level2": "On demand and in person, is an individual voluntary process based on confidence",
                            "level3": "Some teams/units/departments have, as part of their institutional processes",
                            "level4": "Formal process under development in the entire institution",
                        ...
                        },
                        {
                            ...
                            "level3": "Some teams/units/departments have, as part of their institutional processes",
                            "level4": "Formal process under development in the entire institution",
                            "level5": "Established in a formal process and operationalized among areas of the institution with continuous improvement",
                            "runtimeType": "question"
                        }
                    ]
                },
                {
                    ...
                    "subTitle": "Knowledge management and sharing policies, processes, infrastructure, tools and skills strengthening as part of a learning organization framework.",
                    ...
                    "level3": "Basic KM infrastructure (e.g., share information repositories, content management standards, etc.) is in place. Some CG projects have been launched at some levels of the institutional structure.:KM skills strengthening is part of a training program",
                    "level4": "A formal knowledge management framework has been established within the institutions, with robust policies, processes and mechanisms for knowledge management and knowledge sharing.",
                    ...
                    "items": [
                        ...
                        {
                            "text": "Knowledge management and sharing is integrated into business processes, job descriptions and institutional functions",
                            "level1": "No",
                        ...
                        {
                            "text": "Uuse and evaluation of information technologies in order to support health priorities",
                            "level1": "No",
                            "level2": "Training is encouraged but not formalized capacitation curriculum exists,",
                            "level3": "In process of implementation through institution into the HR policy and partially enforced.",
                            "level4": "Yes, implementation based roadmap is ongoing but not fully implemented, effective resources allocation varies with years",
                        ...
                        },
                        {
                            ...
                            "level3": "Some teams/units/departments do as part of their routine, with their own selection criteria.",
                            "level4": "Yes, there are key shared tools and platforms among public health system",
                            "level5": "Yes, standardized and interoperable within institution",
                            "runtimeType": "question"
                        },
                        {
                            "text": "Web 2.0",
                        ...
                        },
                        {
                            ...
                            "level1": "No",
                            "level2": "Some facilities/units/areas do as part of their ins.titutional processes",
                            "level3": "Formal process under development in the entire institution.",
                            "level4": "Yes, established in a formal process and operationalized among areas of the organization for some qualified staff.",
                            "level5": "Yes, established in a formal process and operationalized among all staff in all areas of the institution.",
                            "runtimeType": "question"
                        }
                    ]
                },
                {
                    ...
                    "subTitle": "Strategic tools and methodologies for supported decision-making. Public health communication strategy on institutional priority issues, as well as promoting (individual, social, and political) changes that lead to achievement and maintenance of health.",
                    "level1": "There are routine public health communications on institutional priority issues (e.g., healthy lifestyle, vector control, etc.).:Data and information typically flow only from entity (source) to central level.",
                    ...
                    "level4": "There is a public health communication strategy with defined messages customized for specific audiences and purposes informed by institutional evidence.:institutional authorities can measure the impact of strategic communications, and adjust communications strategies accordingly.",
                    ...
                    "items": [
                        {
                            ...
                            "level1": "No, some communications are oriented to institutional priority issues when occur (vector control, outbreaks, disasters).",
                            ...
                            "level4": "There is a health communication strategy with targeted messages to specific audiences and purposes informed by institutional evidence",
                        ...
                        },
                        {
                            ...
                            "level1": "Information stays at the level of collection, used for self reports or specific reports to institutional or interinstitutional level",
                            "level2": "Routinely from source to central level, with no feedback to the local level .",
                        ...
                        },
                        {
                            ...
                            "level3": "mix of institiutional data and intelligence and external evidence",
                            "level4": "Institutional generated data and intelligence",
                            "level5": "Advanced analytics, structured and unstructured data by institutional capacities",
                            "runtimeType": "question"
                        }
                    ]
                },
                {
                    ...
                    "level4": "Civil society institutions and the public are constantly engaged",
                    "level5": "Decisions by institution are transparent, driven by evidence and engagement with civil society and the public.",
                    "items": [
                        {
                        ...
                        },
                        {
                            ...
                            "level5": "Yes, continuously integrated into decision-making through a variety of engagement mechanisms.",
                            "runtimeType": "question"
                        }
                    ]
                },
                {
                    ...
                    "subTitle": "The academic and scientific communities contribute to research and producing new knowledge in health.",
                    ...
                    "level3": "Formal relationships with academia have been established to expand institutional knowledge and learning.",
                    ...
                    "items": [
                        {
                            ...
                            "level3": "Expand institutional knowledge and learning (training activities) based on formal relationship.",
                        ...
                        {
                            "text": "The institution has an expert advisory group of selected external experts.",
                ...
                {
                    "title": "Networks",
                    "subTitle": "Different types of networks implemented, such as: strategic and diplomatic networks of relations, thematic and knowledge networks, and social networks for community engagement",
                    ...
                    "level4": "Knowledge networks are integrated into institutional structures and practices by a resources and compensations program.",
                    "level5": "As an integrated institutional practice, participating and creating networks is focused in helping the institution to continually identify and adopt emerging knowledge.",
                    "items": [
                        {
                            "text": "There are internal networks for knowledge sharing",
                            "level1": "No, but staff participates and organize ad hoc.",
                            "level2": "Staff and leadership participate ad hoc in local initiatives. (communities of practice, conferences, listservs).",
                            ...
                            "level5": "Knowledge networks are integrated into institutional structures and practices as a way of identify and adopt emerging knowledge.",
                            "runtimeType": "question"
                        },
                        {
                            "text": "Interprogramatic networks for specific projects are",
                            "level1": "Not created, decisions are made by the entity or staff with the direct responsibility.",
                            "level2": "No, but some teams create ad hoc networks to implement some projects.",
                            "level3": "There are some successful formal initiatives at the team/unit level, but not part of departamentel/institutional routine.",
                            "level4": "Yes, is encouraged by management as part of project implementation.",
                            "level5": "There is a mechanism in place for each project to create interprogramatic or multisectoral networks to generate better impact and results.",
                            "runtimeType": "question"
                        },
                        {
                            "text": "Participation in interinstitutional networks for knowledge sharing",
                            "level1": "No",
                            "level2": "Staff and leadership participates ad hoc in interinstitutional initiatives (communities of practice, conferences, listservs).",
                            "level3": "Participation in interinstitutional knowledge network is encouraged by leadership, as an essential way for capturing and sharing knowledge.",
                            "level4": "Participation in interinstitutional knowledge network is part of the staff responsibility and is included in job descriptions.",
                            "level5": "Is integrated into institutional structures and practice as a way to identify and adopt emerging knowledge.",
                            "runtimeType": "question"
                        }
                    ]
                }
            ...
            "groups": [
                {
                    ...
                    "level3": "Most leadership and staff have an understanding IS4H concepts. There are recent assessments that demonstrate strong digital literacy among most leadership and staff.",
                    "level4": "Knowledge of IS4H Key Concepts and digital literacy is high among leadership and staff, and there is evidence that these concepts are routinely applied in practice at all levels of the institution.",
                ...
                },
                {
                    ...
                    "subTitle": "A systematic approach for health needs assessments; accessibility of essential information; advanced analytical techniques to support real time clinical, management, policy and decision making.",
                    ...
                    "level2": "There is evidence that data and information are routinely used to support policy and management decision-making based on mostly descriptive analysis.",
                    ...
                    "items": [
                        ...
                        {
                            "text": "Public Health Modeling/Data science: Predictive analysis based on machine learning, deep learning neural networks; clustering, anomaly, association rule mining, prediction",
                            "level1": "No knowledge or beginner",
                            "level2": "Developing (awareness of the key concepts among leadership and staff)",
                            "level3": "Competent (health analysis skills strengthening is part of a training program)",
                            "level4": "Advanced (Continuous capacity building framework on health analysis in place)",
                        ...
                        },
                        {
                            ...
                            "level5": "Yes, fully implemented at the institutional health system",
                            "runtimeType": "question"
                        },
                        {
                            "text": "Inferential statistics",
                        ...
                        {
                            "text": "Institutional strategic plan is based on data driven situation analysis",
                            "level1": "there is not current institutional strategic plan",
                            "level2": "there is a current institutional strategic plan but data is not recent",
                            "level3": "there is a current institutional strategic plan",
                            "level4": "there is a current institutional strategic plan, accessible online, which includes trend analysis",
                            "level5": "there is a current institutional strategic plan, accessible online, which includes trend analysis and burden of disease analysis and health systems strength analysis",
                            "runtimeType": "question"
                        },
                        {
                            "text": "Health analysis available allow prioritization, monitoring and evaluation, benchmarking",
                            "questions": [],
                            "runtimeType": "subGroup"
                        },
                        {
                            ...
                            "level5": "Health analysis to identify vulnerable populations at institutional, subinstitutional and local level are done for monitoring and targeting interventions (data flow, timeliness, representativeness optimal)",
                            "runtimeType": "question"
                        },
                        {
                        ...
                        },
                        {
                            ...
                            "level3": "analysis institutionalized but not implemented that would allow continuous prioritization/M&E",
                            "level4": "institutionalized and implemented that allow continuous prioritization/M&E but operationally issues exist (representativeness, timeliness)",
                            "level5": "Health analysis to identify vulnerable populations local level are done for monitoring and targeting interventions (data flow, timeliness, representativeness optimal)",
                            "runtimeType": "question"
                        },
                        {
                            ...
                            "level4": "Description of current health situation, detect, monitor",
                            "level5": "Descript, detect, monitor, raise awareness, and past trends",
                            "runtimeType": "question"
                        },
                        {
                            "text": "The organization has a formal mechanism for human resources development on health analysis",
                            "level1": "No",
                            "level2": "No formal mechanism: Some teams/units/departments encourage their HR for development but is not formalized and is based on individual commitment",
                        ...
                        },
                        {
                            ...
                            "level1": "No",
                            "level2": "Some teams/units/departments encourage their HR for development but is not formalized and is based on individual commitment",
                ...
                {
                    "title": "Tools",
                    "subTitle": "Health analysis and business intelligence tools are available for advanced approaches to health information.",
                    "level1": "Basic tools are routinely used for health analysis (e.g., spreadsheets, MS EXCEL, Access, etc.)",
                    ...
                    "level4": "Advanced tools are routinely used for health analysis (e.g., spreadsheets, statistical packages, etc.) and all data is stored in relational databases and new approaches for non traditional databases are initiated, tools are continuously updated and improved. Online data platform is available.",
                    ...
                    "items": [
                        ...
                        },
                        {
                            ...
                            "level1": "No",
                            "level2": "Some teams/units/departments do randomly",
                            "level3": "Some teams/units/departments do as part of their routine.",
                            "level4": "Yes, is the standardized and interoperable health analysis tool used among public health system",
                            "level5": "Yes, is the standardized and interoperable health analysis tool used in institution",
                            "runtimeType": "question"
                        },
                        {
                        ...
                        },
                        {
                            ...
                            "level5": "A institutional DWH is updated, sustainable, easy access, full documentation and data can be shared across institution and stakeholders",
                            "runtimeType": "question"
                        },
                        {
                            "text": "Institution disseminates data/information/analysis through",
                ...
                },
                {
                    ...
                    "subTitle": "Digital health tools being used to transform data collection, models of care, improve patient safety, quality of care and supporting population health approaches. Health care and service are delivered virtually.",
                    "level1": "Health care delivery and services are largely manual processes. Assessing digital technologies in health incl health information systems at institutional level to identify areas of improvement.",
                    ...
                    "level3": "There is evidence of digital health tools being used to transform models of data collection, care, improve patient safety and quality of care, or for supporting population health approaches. Appropriate legislation and data protection policies around data access, sharing, consent, security, privacy, interoperability are being developed",
                    ...
                    "level5": "Digital health technology enables population health management and the rapid response to disease incidents and public health emergencies. Citizens are empowered to manage their own health and to proactively engage with health care providers. Health care workers have access to data and tools that support real-time decision making.",
                    "items": [
                        {
                            "text": "Current digital health initiatives",
                            "level1": "Some isolated and fragmented, stand alone ICT solutions",
                            "level2": "At the entitity (local) level Digital Health initiatives are developed or adopted with no consideration of interoperability and IT standards issues.",
                            "level3": "Starting to improve/plan a integrated digital health environment. Integration of entity (local) initiatives in progress.",
                        ...
                        {
                            "text": "Development of institutional digital health policy and strategies",
                            "level1": "The institution plans specific digitalization actions",
                            "level2": "The institution has a digital strategy in progress.",
                            "level3": "The institution has a specific digital strategy for health developed and in progress of implementation.",
                            "level4": "The institution has a specific digital health strategy with a multi-year budget",
                            "level5": "The institution has a specific digital health strategy that is aligned with the international digital strategy and has a multi-year budget",
                            "runtimeType": "question"
                        },
                        {
                            "text": "Telemedicine",
                            "level1": "not on the agenda",
                            "level2": "The institution has a telemedicne strategy in progress.",
                            "level3": "The institution has a specific telemedicine strategy for health developed and in progress of implementation.",
                            "level4": "In process of implementation through all the institution.",
                            "level5": "The institution has a telemedicine strategy which is aligned with international actors.",
                            "runtimeType": "question"
                        }
                    ]
                },
                {
                    "title": "E-Government",
                    "subTitle": "Integration of the health sector on the eGovernment initiatives, including the adoption of standards, applications, and information services to transform transactions between government and the public, businesses, or other organizations in health.",
                    "level1": "E-government is not on the institutional agenda.",
                    "level2": "E-government is on the institutional agenda, but there is no formal strategy or unit in place.",
                    ...
                    "items": [
                        {
                            "text": "E-government is on the institutional agenda (Citizens interaction with government)",
                            "level1": "No",
                        ...
                        {
                            "text": "Level of integration of institutional health authorities in e-government initiatives",
                        ...
                        {
                            "text": "Integration of Health specific public portals or health e-service with the institutional e-government platform",
                            ...
                            "level3": "Some isolated public health e-services from facilities teams/units/departments are integrated with institutional e-government platform",
                            "level4": "Yes, Public health e-services are integrated but not with all sectors/stakeholders (correct statement?)",
                            "level5": "Yes, Public health e-services are fully integrated with institutional e-government platform (e.g. single point of entry; single sign-on)",
                            "runtimeType": "question"
                        }
                    ]
                },
                {
                    ...
                    "subTitle": "Public access and effective oversight to government documents and proceedings. Open Data principles application and data sets availability.",
                    "level1": "The concepts of Open Government are new to leadership.",
                    "level2": "There is broad knowledge of open government principles among institutional health authorities, and leadership support for advancing open government policies and initiatives.",
                    "level3": "Open data principles have been formally adopted in policy.",
                    "level4": "Open data principles are fully applied, and key data sets are available for analysis by other institutional and interinstitutional stakeholders.",
                    "level5": "Open data principles are fully applied. Full interaction with institutional and interinstitutional partners regarding the use of data analysis to strengthen decision making.",
                    "items": [
                        {
                        ...
                        },
                        {
                            ...
                            "level1": "no",
                            "level2": "some units/departments work on open data as part of institutional processes",
                            "level3": "Formal process under development in the entire organization",
                            "level4": "Yes, documented and implemented at institutional levels",
                            "level5": "Yes, documented and implemented at institutional level",
                            "runtimeType": "question"
                        },
                        {
                            "text": "Principles of “openness” integrated into institutional policy",
                            "level1": "No",
                ...
                },
                {
                    ...
                    "subTitle": "Capacity of the information systems for health to operate during and after emergencies and disasters requires the development and application of special operating procedures to ensure access to the right information at the right moment in the right format.",
                    ...
                    "level5": "IS4H are fully resilient during disasters. The operation of information systems for health and access to information is available during and after emergencies and disasters.",
                    "items": [
                        {
                        ...
                        },
                        {
                            ...
                            "level1": "No",
                            "level2": "Some teams/units/departments have infrequent key data sets",
                            "level3": "Some teams/units/departments routinely update key data sets",
                            "level4": "Fully implemented at the specific programmatic department",
                            "level5": "Yes, fully implemented in institution",
                            "runtimeType": "question"
                        },
                        {
