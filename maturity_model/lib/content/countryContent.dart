      ...
      "groups": [
        {
          ...
          "level1":
              "Data is not collected and some data is available from external estimations (international organizations)",
          "level2":
              "Date is sometimes obtained from few sources, largely using paper-based methods, although a few simple electronic tools like spreadsheets may be used for some data sources.  Data frequently has limited utility because of quality or disaggregation issues. Some indicators definitions are defined but not easily accessible/shared.",
          "level3":
              "Health data are routinely from key data sources. Data is collected electronically using a variety of tools like spreadsheets, databases and electronic client-based information systems.  Integration from different sources is often a manual process, and may be constrained by comparability issues.",
          "level4":
              "Health data is derived routinely and timely form all key data sources. The country carries out proactive activities to improve data collection processes.  Some data is available in near-real time to support decision-making.",
          "level5":
          ...
          "items": [
            {
              "text":
                  "For each structured key data source, identify how often data is collected/updated.",
              "questions": [],
            ...
            {
              "text":
                  "For the country structured key data sources identify how data is collected (format):",
              "questions": [],
              "runtimeType": "subGroup"
            },
            {
              ...
              "level3":
                  "All data is collected electronically, mostly using databases or other electronic client-based information systems.  Data integration from various sites is done manually.",
              "level4":
              ...
              "level5":
                  "A data is collected e data sets integrated across multiple sources (e.g. acrsoss different data sources or different institutions, or sub-national and national levels). All relevant data is available in real or near-real time for decision-making (e.g. dashboards).",
              "runtimeType": "question"
            },
            {
              "text": "Health service (production) records",
              ...
              "level4":
                  "All data is collected electronically into integrated data repositories from multiple sites for specific data sources. Some data is available in real or near-real time for decision-making (e.g. dashboards).",
              "level5":
                  "A data is collected e data sets integrated across multiple sources ( different data sources or different institutions, or sub-national and national levels). All relevant data is available in real or near-real time for decision-making (e.g. dashboards).",
              "runtimeType": "question"
            },
            {
              "text": "Public Health Surveillance ",
            ...
            {
              "text":
                  "For each data source, disaggregation is available for the following variables (dimensions for equity measurement):",
              "questions": [],
              "runtimeType": "subGroup"
            },
            {
              ...
              "level4":
                  "Age by birth date, sex, subnational location, income level, education level",
              "level5":
                  "Age by birth date, sex, subnational location, income level, education level and other equity characteristic relevant to country (e.g. ethnicity, migration status, disability, sexual identity, etc.)",
              "runtimeType": "question"
            },
            {
              "text": "Public Health Surveillance ",
            ...
            {
              "text":
                  "For each data source: Data quality of variables are good quality (completeness and accurate). ",
              "questions": [],
              "runtimeType": "subGroup"
            },
            {
              ...
              "level1": "Not collected",
              "level2":
                  "Data is collected, but often cannot be used due to completeness and accuracy problems.",
              "level3":
                  "The are known completeness and accuracy problems for some data elements.  Data from different sources are often not comparable due to quality issues.",
              "level4":
                  "Data is generally reliable complete and accurate for all data elements for at least 5 years. Biases/issues are known and analyses can be accordingly adjusted.  Data is comparable across sources and time.",
              "level5":
                  "Data is reliably complete and accurate for at least 10 years.",
              "runtimeType": "question"
            },
            {
              "text": "Health service (production) records",
              ...
              "level3":
                  "The are known completeness and accuracy problems for some data elements.  Data from different sources are often not comparable due to quality issues.",
              "level4":
                  "Data is generally reliable complete and accurate for all data elements for at least two years. Biases/issues are known and analyses can be accordingly adjusted.  Data is comparable across sources and time.",
              "level5":
                  "Data is reliably complete and accurate for at least five years.",
              "runtimeType": "question"
            },
            {
              "text": "Surveillance ",
            ...
            },
            {
              ...
              "level1":
                  "Health expenditure data relies on external estimations from international organizations.",
              "level2":
                  "Health expenditure data relies on survey estimates and ad hoc studies.",
              "level3":
                  "There is at least 1 year of collection and classification of health expenditure data using the SHA 2011 system.",
              "level4":
                  "There is a time series of health accounts data (SHA 2011) for at least 3 years.",
              "level5":
                  "There is a system of national health accounts that produces annual health expenditure data, monitors health system performance and benchmarks health care spending. The government has established a health accounts team.",
              "runtimeType": "question"
            },
            {
              "text":
                  "Information Products::Health data that are processed and published openly in a variety of formats that accomplish the different needs of IS4H constituencies.",
              "level1":
                  "Indicator are not generally produced by the national health authorities.  Indicators rely heavily on estimates from international organizations.",
              "level2":
                  "Some information products are generated, but not routinely, require intensive work and use of resources. Data is not readily shared across units, with stakeholders or public. Sharing data frequently requires permission from senior levels.  Indicators generation largely relies on data from survey's, census, and other ad hoc studies.",
              "level3":
                  "A range information products are efficiently and routinely produced from varies country information systems that may complement each other.  Dissemination of information products is typically limited to senior-level decision makers.",
              "level4":
            ...
            {
              "text":
                  "(Cancer incidence, fasting blood glucose-diabetes) Non Communicable Diseases",
              "level1": "International estimations",
            ...
            {
              "text":
                  "Indicator and event-based surveillance system in  place based on IHR standards",
              "level1": "None",
              "level2": "Planned",
            ...
            },
            {
              ...
              "level3":
                  "Most indicators routinely reported on defined schedule",
              "level4":
                  "All indicators routinely available on a defined schedule",
            ...
            },
            {
              ...
              "level4":
                  "Disseminated to stakeholders throughout the health system",
            ...
            },
            {
              ...
              "level5":
                  "A release calendar for population census results is published and all  results online",
              "runtimeType": "question"
            },
            {
              ...
              "level4": "Preliminary and final results available online",
              "level5":
                  "A release calendar for population survey results is published and all  results online",
              "runtimeType": "question"
            },
            {
              ...
              "level3":
                  "An institutional platform exists and updated less than annually and with limited content of indicators",
              "level4":
                  "An institutional platform is updated frequently with extensive coverage of health statistics",
              "level5":
                  "A national platform is updated frequently with full coverage of health statistics and open access",
              "runtimeType": "question"
            },
            {
            ...
            {
              "text":
                  "WHO International Classification Family (e.g. ICD-9/10/11, ICPC, ICF)",
            ...
            {
              "text":
                  "A set of national core health indicators including definitions and metadata exists",
              "level1": "No awareness or plans to adopt.",
              "level2": "There is general awareness , but no plans to adopt.",
              "level3": "Defined and implemented for some sources",
              "level4": "Formally defined and adopted nationally. ",
            ...
            {
              "text":
                  "Definitions and metadata for a the Sustainable Development Goals (SDGs)",
              "level1": "No plans to adopt.",
              "level2":
                  "There is general awareness but no plans to dedicate resources to monitor SDG",
              "level3": "Defined and implemented to monitor some SDG ",
              "level4":
                  "Formally defined SDG set of indicators and adopted nationally. In process to indicators that are currently not being collected. Expansion of   disaggregated data.",
              "level5":
                  "A national set of SDG - tailored to country priorities - fully adopted and monitored, including disaggregation",
              "runtimeType": "question"
            },
            {
              ...
              "level1": "None",
              "level2":
                  "Unique identifiers at the facilities not unique to the individual, but no identity management.",
              "level3":
                  "Unique identifier at the facility level with identity management",
              "level4":
                  "Unique identifier for the public health system, converging with identifiers at the health facilities",
            ...
            },
            {
              ...
              "level4":
                  "Data sources, data flows,  data repositories, messaging and data standards documented and partially implemented within the national health system",
              "level5":
                  "National health information architecture fully implemented",
              "runtimeType": "question"
            },
            {
              "text":
                  "Data Governance::Health data governance is the framework for establishing sub-regional and national strategies, objectives, policies, standards, and tools for the management of technical data, which is supported by a legal framework.",
              "level1":
                  "There a few if any best practices for data management implemented.  Data management is largely ad hoc.  There are no formal mechanisms for decisions about data quality and standards.",
              "level2":
                  "Data management best practices are in development, but not fully implemented.  Data quality is not routinely monitored.  Decision about standards quality and standards are made at the facility/unit/team level.",
              "level3":
                  "Data management processes and best practices are implemented for some facilities/units/teams.  (e.g. Data quality frameworks, data standards, policies, SOPs,…) Core sets are readily available. Data are rarely integrated for analysis across various sources. Some metadata are documented and maintained (indicator compendium, data dictionaries). A data governance body within the national health authority exists.",
              "level4":
                  "A formal health data governance mechanisms has been established at the national level with other health data stakeholders, and there are processes and plan in place to strengthen alignment of standards, data quality frameworks and data management practices across all stakeholders. ",
              "level5":
            ...
            },
            {
              ...
              "level3":
                  "The national health authority has established a formal body for making decisions about data",
              "level4":
                  "There is a national body that makes decisions about health data that meets and works across sectors including part of private sector",
              "level5":
                  "There is a national body that make decisions about data and that functions and works across sectors including the private sector",
              "runtimeType": "question"
            },
            {
              ...
              "level1": "No framework",
              "level2":
                  "Some facilities/units/teams work on data quality but no data quality framework exists.",
              "level3":
                  "There is a data quality framework for the national health authorities.",
              "level4":
                  "There is a data quality framework that is shared or aligned between national health authorities and some key multisectoral stakeholders",
              "level5":
                  "There is a data quality framework that is aligned and fully implemented at the national health system",
              "runtimeType": "question"
            },
            {
              "text":
            ...
            },
            {
              ...
              "level1": "No",
              "level2":
                  "Defined for facilities/units/teams, but not formally implemented",
              "level3": "Fully implemented in some facilities/units/teams",
              "level4":
                  "Fully implemented and aligned across national health authorities",
            ...
            {
              "text":
                  "IT Infrastructure::Availability and maintenance of Tools, Networks, Hardware and Software to support IS4H. Interoperability among platforms and integration of data repositories.",
              "level1":
              ...
              "level4":
                  "Widely available and interoperable across the public health system.",
              "level5":
                  "There is evidence of significant interoperability across health platforms. Integrated national repositories from multiple data sources.",
              "runtimeType": "question"
            },
            {
              "text":
                  "There is IT governance body in place to supervise ICT standards; ICT performance; policies and to coordinate investments. ",
              "level1":
                  "There are no formal mechanism for making decisions about IT.",
              "level2":
                  "Decision about IT are made within the facility/unit/team.",
              "level3":
                  "The national health authority has established a formal body for making decisions about IT.",
              "level4":
                  "There is a national body that makes decisions about some aspects of publics sector IT, and coordinates investments.",
              "level5":
                  "There is a national body that coordinates investments in both public and private sector investments in IT.",
              "runtimeType": "question"
            },
            {
            ...
            },
            {
              ...
              "level3":
                  "Available in all facilities with some interoperability within facilities",
            ...
            {
              "text":
                  "Mortality information system/national vital statistics system",
              "level1": "Not available",
              "level2": "Available in some facilities",
              "level3":
                  "Available in all facilities with some interoperability within facilities",
            ...
            },
            {
              ...
              "level4":
                  "Fully implemented and aligned across national health authorities",
              "level5":
                  "Yes, fully implemented at the national public sector level.",
              "runtimeType": "question"
            },
            {
      ...
      "groups": [
        {
          ...
          "level1":
              "Accountability and decision-making for IS4H components is distributed across different units within national health authorities, and investments and activities are not coordinated.",
          "level2":
              "IS4H investment decisions are coordinated at the management level within individual national health authorities (e.g., MOH, reginal health authorities, health facilities, etc.) but not formally coordinated among health authorities or other national actors.",
          "level3":
              "There is a formal governance structure in place for strategic planning and oversight of IS4H among the national health authorities (e.g. MOH, regional health authorities, health facilities, etc.).",
          "level4":
              "IS4H governance structures are established at the national level across at least some key national stakeholders (e.g. health authorities, national IT authorities, vital Statistics,  national statistics authorities)",
          "level5":
              "The governance and management of IS4H is fully transparent and integrated across all national stakeholder organizations.",
          "items": [
            {
              "text":
                  "Roles and functions of key national health system actors are formally documented and mapped.",
              "level1":
                  "No mapping or documentation exist. Knowledge of roles and functions of health system actors resides in individuals",
              "level2":
                  "Individual institutions have mapped the roles and functions of some key stakeholders but not shared at the national level.",
              "level3":
                  "There is a formal roster of national health system actors (public and private) documented and available.",
              "level4":
                  "There is a formal roster of national health system actors (public and private with a mapping of roles and relationships.",
              "level5":
                  "Health sector functions, roles and responsibilities are mapped, integrated and aligned across national health system actors.",
              "runtimeType": "question"
            },
            {
              "text":
              ...
              "level1":
                  "Decision for IS4H are only  addressed at the unit/facility level",
              "level2":
                  "There is no formal governance structure within the National Health Authority, but IS4H issues are routinely  discussed within the  National Health Authority  executive leadership body.",
              "level3":
                  "There is a formal IS4H governance structure within the National Health Authority.",
              "level4":
                  "There is a national governance structure that at a minimum includes National Health Authority, vital statistics authority, national statistics authority, and the national IT/e-gov authority.",
              "level5":
                  "The national governance structure is integrated with the IS4H governance structure s in  national stakeholder organizations (e.g. organizational IS4H governance structure reference the national IS4H body in Terms of Reference  or reporting structures).",
              "runtimeType": "question"
            },
            {
              "text":
                  "Strategic and Operational Plans::Addressing IS4H under policies, strategies and SOPs at the national, regional and local level.  Mechanisms for developing or adopting an IS4H governance strategy or policy that promotes a better decision- and informed policy-making mechanisms.",
              "level1":
                  "There is no current National Health System Strategic Plan, and IS4H components are not reflected in operational plans.",
              "level2":
                  "There is a National Health System Strategic Plan, but it does not address IS4H.  Some individual units/departments/facilities include some components of IS4H in their operational plans.",
              "level3":
                  "There is a current National Health System Strategic Plan that include priorities for strengthening health information.  IS4H is included within operational plans of national health authorities.",
              "level4":
                  "There is a formal strategic plan in place among national health authorities for strengthening IS4H that reflects the IS4H Strategic Framework. Operational plans of the units within national health authorities reflect IS4H activities and outcomes based on the IS4H Strategic Plan.  ",
              "level5":
                  "There is a National IS4H Strategic Plan, and operational plans are aligned and integrated across multisectoral stakeholders.",
              "runtimeType": "question"
            },
            {
              "text": "There is a National IS4H Strategic Plan.",
              "level1":
                  "There is no current National Health System Strategic Plan.",
              "level2":
                  "There is a current National  Health System Strategic Plan, but it does not address components of IS4H.",
              "level3":
                  "There is a current National Health System Strategic Plan that includes a priority for strengthening health information that reflects two or more strategic domains within the IS4H framework.",
              "level4":
                  "There is a formal strategic plan in place among national health authorities for strengthening IS4H that reflects all of the domains in the IS4H Strategic Framework",
              "level5":
                  "There is a specific National IS4H Strategic Plan that include strategic goals and initiatives from multi-sectoral partners.",
              "runtimeType": "question"
            },
            {
              "text": "There are IS4H operational plans.",
              "level1":
                  "IS4H components are not reflected in operational plans of the national health authority.",
              "level2":
                  "Some units/departments/facilities include some IS4H components in their individual operating plans.",
              "level3":
                  "IS4H is specifically included within the operational plans of national health authorities.",
              "level4":
                  "IS4H is included within the operational plans of national health authorities, and is aligned with National IS4H Strategic Plan.",
              "level5":
                  "IS4H is included within the operational plans of multisectoral stakeholders, and aligned or integrated across stakeholders within the framework of the National IS4H Strategic Plan.",
              "runtimeType": "question"
            },
            {
              "text":
                  "Organizational Structures and Functions::Organizational Structure & Information flows of health-related institutions. Roles and responsibilities IS4H health system actors.",
              "level1":
                  "Some IS4H functions are formally defined and performed, but there are significant gaps",
              "level2":
                  "There are gaps in IS4H services or functions, and/or services and functions may be duplicated across units/programs. ",
              "level3":
                  "Accountability and responsibility for IS4H functions within national health authorities have been defined, and there are plans in place for organizational restructuring or re-alignment to rationalize functions and decision-making.",
              "level4":
                  "An organizational structure that defines clear accountabilities and responsibilities for IS4H has been fully implemented within/among national health authorities, and is reflected in unit/program mandates and job descriptions.   ",
              "level5":
                  "IS4H functions are defined, performed and aligned across national stakeholders.  Functions are integrated  across national stakeholders, optimizing performance, value and investments at the national level.",
              "runtimeType": "question"
            },
            {
              "text":
                  "There is a documented and formally adopted organizational structure (organigram) for the national health authority (e.g. Ministry of Health and/or other national and sub-national health authorities).",
              "level1":
                  "No formal organizational structure for the national health authorities are defined.",
              "level2":
                  "Yes, but the organizational structure has not yet been formally approved or published.",
              "level3":
                  "Yes, but IS4H roles and responsibilities are not fully reflected.",
              "level4":
                  "Yes, with IS4H roles and responsibilities fully reflected.",
              "level5":
                  "Yes, with IS4H fully reflected and aligned with organizational structures across national multisectoral partners.",
              "runtimeType": "question"
            },
            {
              "text":
                  "The overall leadership and accountability for IS4H is defined within the organization is defined.",
              "level1":
                  "IS4H responsibility is not currently defined in the organization, and there is no clear leadership for IS4H.",
              "level2":
                  "Responsibility for IS4H is defined within national health authorities for individual components, but there is no clear overall leadership role defined.",
              "level3":
                  "Leadership for IS4H is defined, and there are formal plans for organizational re-structuring to clearly define roles and responsibilities within the national health authorities.",
              "level4":
                  "Responsibility for IS4H is defined and integrated within national health authorities, and leadership is well defined.",
              "level5":
            ...
            },
            {
              ...
              "level2":
                  "There is awareness of  principles, but no organizational capacity to implement change management methodologies",
              "level3":
                  "Some capacity for change management but lack organizational resources",
              "level4":
                  "There are formal and efficient change management program unit or team.",
              "level5":
            ...
            {
              "text":
                  "There are formally defined organizational functions for:",
              "questions": [],
              "runtimeType": "subGroup"
            },
            {
              ...
              "level2":
                  "Most functions are performed but not formally defined, and/or their are  overlapping accountabilities or duplication of efforts.",
              "level3":
                  "Functions are defined, and there are plans to address gaps and to align accountabilities.",
              "level4":
                  "Functions are fully defined and  accountabilities are aligned within the national health authority",
              "level5":
                  "Functions are fully defined and accountabilities are aligned across national multisectoral partners",
              "runtimeType": "question"
            },
            {
            ...
            },
            {
              ...
              "level2":
                  "There are some policies/SOPs defined to guide IS4H activities and processes, but many are out of date, or not formally adopted within national health authorities.",
              "level3":
                  "Specific gaps in policies/SOPs have been identified, and there are plans in progress to update and adopt policies/SOPs within national health authorities.",
              "level4":
                  "Policies/SOPs are well defined and formally adopted to guide IS4H activities and processes within the national health authorities.",
              "level5":
                  "Policies/SOPs are to guide IS4H activities and processes, and are integrated and aligned across national multi-sectoral stakeholders.",
              "runtimeType": "question"
            },
            {
              "text": "Information Management and Analysis",
            ...
            {
              "text":
                  "Financial Resources::Budget for IS4H implementation, sustainability, investment. Resources mobilization plans and ERP systems.",
              "level1":
                  "IS4H activities/resources are not formally identified in program/unit budgets. While it is sometimes possible to secure one-time financial resources for IS4H investments, required investments are difficult to sustain.",
              "level2":
                  "IS4H activities are identified in individual unit/program annual budgets of national health authorities, but are not integrated or aligned across units/programs.   The financial resources requirements to effectively sustain IS4H have been identified, but there is no plan to address gaps.",
              "level3":
                  "There is a plan in place for resource mobilization for specific IS4H capital investments, and financial resources required for the sustainable implementation and operations of IS4H have been secured with annual budgets.",
              "level4":
                  "An IS4H investment framework is established at the national level.",
              "level5":
            ...
            },
            {
              ...
              "level4":
                  "There is an IS4H investment framework at the national level that identifies financial resource requirements, and investment sources.",
              "level5":
            ...
            },
            {
              ...
              "level3":
                  "Individual units/departments/facilities have line-items for some IS4H components in their budgets, but it is not possible to roll-up these budgets as the organizational or national health authority level.",
              "level4":
                  "There are specific budget line-items for IS4H components that are consistent across units/departments/facilities, and that can be rolled up across national health authorities.",
              "level5":
                  "There are specific budget line-items for IS4H components that are consistent across multi-sectoral stakeholders that can be rolled up at the national level.",
              "runtimeType": "question"
            },
            {
              "text":
                  "Human Resources::Human capital for planning, implementing, and managing IS4H. Competency building activities to strengthen to IS4H skills. Job functions identified to effectively support IS4H.",
              "level1":
              ...
              "level5":
                  "There is a national strategy for building IS4H human resource competencies that includes national and international educational institutions to ensure the long term availability of skilled IS4H resources.",
              "runtimeType": "question"
            },
            {
            ...
            },
            {
              ...
              "level5":
                  "There is a national IS4H human resource strategy in place aligned with multisectoral partners.",
              "runtimeType": "question"
            },
            {
              "text": "Information Management and Analysis",
            ...
            {
              "text":
                  "Leadership and staff have knowledge of key IS4H concepts to effectively plan, implement and support IS4H across the entire organizations.",
              "questions": [],
              "runtimeType": "subGroup"
            },
            {
            ...
            {
              "text":
                  "There is capacity within the country to educate, train and strengthen the IS4H workforce:",
              "questions": [],
              "runtimeType": "subGroup"
            },
            {
              "text": "Information Technology Management",
              "level1":
                  "There is no national capacity to educate and train human resources.",
              "level2":
                  "There is some technical training capacity in the country.",
              "level3":
                  "There is academic undergraduate education capacity in country.",
              "level4": "There is postgraduate education capacity in country.",
              "level5":
                  "There are advance centers for excellent in country that drive research and innovation in the filled.",
              "runtimeType": "question"
            },
            {
              "text": "Information Management and Analysis",
            ...
            },
            {
              ...
              "level1":
                  "No relationships with stakeholders within the broader public sector",
              "level2":
              ...
              "level5":
                  "National IS4H governance structure provides formal arrangements for the sharing of information across multisectoral partners.",
              "runtimeType": "question"
            },
            {
              "text": "Economy",
            ...
            },
            {
              ...
              "level1":
                  "No relationships with stakeholders within the private sector",
              "level2":
              ...
              "level5":
                  "National IS4H governance structure provides formal arrangements for the sharing of information across private sector partners.",
              "runtimeType": "question"
            },
            {
              "text":
                  "There are established relationships with international organizations and NGOs  for information sharing and coordination.",
              "level1":
                  "No relationships with international organizations/NGO stakeholders.",
              "level2":
                  "Information sharing with international/NGO stakeholders is ad hoc, for some specific information needs.",
              "level3":
                  "Information sharing with international organizations/NGO stakeholders  happens routinely, but not based on a formal agreement.",
              "level4":
                  "There are specific formal agreements for information sharing with international/NGO stakeholders.",
              "level5":
                  "National IS4H governance structure provides formal arrangements for the sharing of information across international/NGO partners.",
              "runtimeType": "question"
            },
            {
              "text":
                  "Legislation, Policy and Compliance::Key and core legislation, policy and compliance mechanisms, elements to enable IS4H implementation, operation and maintenance. ",
              "level1":
            ...
            },
            {
              ...
              "level3":
                  "Some facilities/units/areas have polices as part of their institutional policy framework.",
              "level4":
                  "There are policies at the national level for the public health sector.",
              "level5":
                  "There are policies at the national level that apply to all national multi-sectoral stakeholders.",
              "runtimeType": "question"
            },
            {
              "text":
            ...
            {
              "text":
                  "National and International Agreements::National and International agreements to contextualize national plans and investments.  Commitment to regional and global mandates.",
              "level1":
                  "There is some awareness of data and reporting obligations under national and international agreements, but little capacity to meet obligations.",
              "level2":
                  "Data and reporting obligations under national and international agreements are frequently met, but with high resource impact.",
              "level3":
                  "Data and reporting obligations under national and international agreements are consistently met with an effective use of resources.",
              "level4":
                  "Agreements enable data and information sharing across national and international stakeholders.",
              "level5":
                  "Data and information are able to flow freely among national and international partners in support of agreements, guided by frameworks that ensure the ethical use of information that protects individuals and populations.",
              "runtimeType": "question"
            },
            {
              "text":
                  "Capacity to meet data and reporting obligations under national and international agreements.",
              "questions": [],
              "runtimeType": "subGroup"
            },
            {
              ...
              "level3":
                  "There is sufficient capacity to meet national data and reporting obligations with an effective use of resources.",
              "level4":
                  "There is sufficient capacity to meet national and international data and reporting obligations with an effective use of resources.",
              "level5":
                  "Systems, process and agreements allow data to flow freely between national and international partners.",
              "runtimeType": "question"
            },
            {
              "text": "SDG´s",
            ...
            },
            {
              ...
              "level1":
                  "There is no formal data sharing among national stakeholders.",
              "level2":
                  "There is some data sharing among national stakeholders, but data sharing requirements new agreements or approvals each time.",
              "level3":
                  "Data can be shared routinely among national stakeholders, which contributes to national capacity to meeting national and international data and reporting obligations.",
              "level4":
                  "Data can be shared routinely among national and international stakeholders, which contributes to national capacity to meeting national and international data and reporting obligations.",
              "level5":
                  "Data is able to flow freely among national and international partners guided by frameworks that ensure the ethical use of information that protects individuals and populations.",
              "runtimeType": "question"
            }
          ]
        }
      ...
      "groups": [
        {
          ...
          "subTitle":
              "Knowledge management methodologies and mechanisms to improve decision-making, capture, share and measure organizational knowledge.",
          "level1":
              "Knowledge sharing in the organization is ad hoc and Organizational knowledge resides with key individuals rather that on repeatable processes documented in unit descriptions, job descriptions, policies and SOPs.",
          "level2":
              "There are some basic knowledge management mechanism and processes (e.g. formal meeting notes, trip reports, SOPs, documentation etc.) in place but not always accessible and updated, but these are not required in policy or practice.",
          "level3":
              "There are numerous knowledge management processes defined (lessons learned, trip reports, mentoring, shadowing, etc.) guided by formal policies and procedures. There is a formal basic KM strategy at the organizational level",
          "level4":
              "Knowledge management  sharing is integrated into business processes, job descriptions and organizational functions. Metrics are used to quantitatively measure organizational knowledge management processes and capacities, and continuously improve performance.",
          "level5":
              "Health authorities and their multisectoral partners are fully learning organizations: The organizational culture encourages the free-flow of knowledge throughout the organization, enabled by KM processes, tools and technology.",
          "items": [
            {
              "text":
            ...
            },
            {
              ...
              "level3":
                  "Metrics are used to quantitatively measure organizational knowledge management processes and capacities",
              "level4":
            ...
            },
            {
              ...
              "level3":
                  "Some facilities/units/areas do as part of their institutional processes  ",
              "level4":
            ...
            },
            {
              ...
              "level2": "Practiced ad hoc as an individual initiative",
              "level3":
                  "Some facilities/units/teams are developing a program, currently informal initiatives",
            ...
            },
            {
              ...
              "level3":
                  "Some facilities/units/areas have, as part of their institutional processes  ",
              "level4":
                  "Formal process under development in the entire organization",
              "level5":
            ...
            {
              "text":
                  "Knowledge Architecture::Knowledge management and sharing policies, processes, infrastructure, tools and skills strengthening as part of a learning organization framework.",
              "level1":
              ...
              "level3":
                  "Basic KM infrastructure (e.g., share information repositories, content management standards, etc.) is in place.  Some CG projects have been launched at some levels of the organizational structure. KM skills strengthening is part of a training program",
              "level4":
                  "A formal knowledge management framework has been established within the organizations, with robust policies, processes and mechanisms for knowledge management and knowledge sharing.",
              "level5":
            ...
            {
              "text":
                  "Knowledge management and sharing is integrated into business processes, job descriptions and organizational functions",
              "level1": "No",
            ...
            {
              "text":
                  "Use and evaluation of information technologies in order to support health priorities",
              "level1": "No",
              "level2":
                  "Training is encouraged but not formalized capacitation curriculum exists, ",
              "level3":
            ...
            },
            {
              ...
              "level3":
                  "Some facilities/units/teams do as part of their routine, with their own selection criteria.",
              "level4":
            ...
            },
            {
              ...
              "level3":
                  "Formal process under development in the entire organization",
              "level4":
                  "Yes, established in a formal process  and operationalized among areas of the organization for some calefied staff",
              "level5":
                  "Yes, established in a formal process  and operationalized among areas of the organization for some al staff and sustainable",
              "runtimeType": "question"
            },
            {
              "text":
                  "Strategic Communications::Strategic tools and methodologies for supported decision-making. Public health communication strategy on national priority issues, as well as promoting (individual, social, and political) changes that lead to achievement and maintenance of health.",
              "level1":
                  "There are routine public health communications on national priority issues (e.g., healthy lifestyle, vector control, etc.). Data and information typically flow only from source to the central level.",
              "level2":
              ...
              "level4":
                  "There is a public health communication strategy with defined messages customized for specific audiences and purposes informed by national evidence. National authorities can measure the impact of strategic communications,  and adjust communications strategies accordingly.",
              "level5":
            ...
            },
            {
              ...
              "level1":
                  "No, some communications are oriented to National Priority issues when occur (vector control, outbreaks, disasters)",
              "level2":
              ...
              "level4":
                  "There is a health communication strategy with targeted messages to specific audiences and purposes informed by national evidence",
              "level5":
            ...
            },
            {
              ...
              "level1":
                  "Information available stays at the level of collection, used for self reports or specific reports to national or international level",
              "level2":
                  "Routinely from sources to central level, with no feedback to the local level ",
              "level3":
            ...
            {
              "text":
                  "Health information for health service delivery management is used ",
              "level1": "No",
              "level2": "Some facilities/units/teams do but not routinely",
              "level3": "Some facilities/units/teams do routinely",
              "level4":
            ...
            },
            {
              ...
              "level4":
                  "Civil society organizations and the public are constantly engaged ",
              "level5":
                  "Decisions by health authorities and other health system actors are transparent, driven by evidence and engagement with civil society and the public.",
              "runtimeType": "question"
            },
            {
              "text":
            ...
            },
            {
              ...
              "level5":
                  "Yes, Integrated into decision-making through a variety of engagement mechanisms, continuously",
              "runtimeType": "question"
            },
            {
              "text":
                  "Academia & Scientific Community::The academic and scientific communities contribute to research and producing new knowledge in health.",
              "level1":
                  "No formal relationships have been established between health authorities and the academic/scientific community.",
              "level2":
                  "Relations with academia are fluid, informal and on demand",
              "level3":
                  "Formal relationships with academia have been established to expand organizational knowledge and learning.",
              "level4":
            ...
            {
              "text":
                  "The organization formally integrates academic institutions in",
              ...
              "level3":
                  "Expand organizational knowledge and learning. (training activities) based on formal relationship",
              "level4":
            ...
            {
              "text":
                  "The organization has an expert advisory group of selected external experts",
            ...
            {
              "text":
                  "Networks::Different types of networks will be implemented, such as: strategic and diplomatic networks of relations, thematic and knowledge networks, and social networks for community engagement.",
              "level1":
              ...
              "level4":
                  "Knowledge networks are integrated into organizational structures and practices by a resources and compensations program.",
              "level5":
                  "As an integrated organizational practice, participating and creating networks is focused in helping the organization to continually identify and adopt emerging knowledge. ",
              "runtimeType": "question"
            },
            {
              ...
              "level2":
                  "Staff and leadership participates ad hoc in local initiatives. (communities of practice, conferences, listservs)",
              "level3":
              ...
              "level5":
                  "Knowledge networks are integrated into organizational structures and practices as a way of identify and adopt emerging knowledge",
              "runtimeType": "question"
            },
            {
              "text": "Interprogramatic networks for specific projects are ",
              "level1":
                  "Not created, the decisions are made by the entity, staff with the direct responsibility",
              "level2":
                  "No, but some teams creates ad hoc networks to implement some projects",
              "level3":
                  "There are some successful formal initiatives at the local/team level, but not part of routine.",
              "level4":
                  "Yes, is encouraged by management as part of project implementation.",
              "level5":
                  "There is a mechanism in place for each project to create interprogramatic or multisectoral networks to generate a better impact and results.",
              "runtimeType": "question"
            },
            {
              "text":
                  "Participation in international networks for knowledge sharing ",
              "level1": "No",
              "level2":
                  "Staff and leadership participates ad hoc in international initiatives. (communities of practice, conferences, listservs)",
              "level3":
                  "Participation in international knowledge network is encouraged by leadership, as an essential way for capturing and sharing knowledge.",
              "level4":
                  "Participation in international knowledge network is part of the staff responsibility and its included in their job descriptions",
              "level5":
                  "Is integrated into organizational structures and practices as a way of identify and adopt emerging knowledge",
              "runtimeType": "question"
            }
          ]
        }
      ...
      "groups": [
        {
          ...
          "level3":
              "Most leadership and staff have an understanding IS4H concepts.  There are recent assessments that demonstrate strong digital literary among most leadership and staff.",
          "level4":
              "Knowledge of IS4H Key Concepts and digital literacy is high among leadership and staff, and there is evidence that these concepts are routinely applied in practice at all levels of the organization.",
          "level5":
          ...
          "items": [
            ...
            {
              "text":
                  "Health Analysis for Decision-Making::A systematic approach for health needs assessments; accessibility of essential information; advanced analytical techniques to support real time clinical, management, policy and decision making.",
              "level1":
              ...
              "level2":
                  "Data typically flows from sources to central decision-makers for health analysis, but little health information is available for decision-making at the local level. There is evidence that data and information are routinely used to support policy and management decision-making.",
              "level3":
            ...
            {
              "text":
                  "Data science:  Predictive analysis based on machine learning, deep learning neural networks; clustering, anomaly, association rule mining, prediction",
              "level1": "No knowledge or beginner ",
              "level2":
                  "Developing (awareness of the key concepts among leadership and staff)",
              "level3":
            ...
            {
              "text":
                  "National Health Sector Strategic plan is based on data driven situation analysis",
              "level1":
                  "there is not current national health sector strategic plan",
              "level2":
                  "there is a current nat. Health sector strategic plan but data is not recent",
              "level3": "there is a current nat. Health sector strategic plan",
              "level4":
                  "there is a current nat. health sector strategic plan, accessible online, which includes trend analysis ",
              "level5":
                  "there is a current nat. health sector strategic plan, accessible online, which includes trend analysis and burden of disease analysis and health systems strength analysis",
              "runtimeType": "question"
            },
            {
              "text":
                  "Health analysis available allow prioritization, monitoring and evaluation ",
              "questions": [],
              "runtimeType": "subGroup"
            },
            {
              ...
              "level5":
                  "Health analysis to identify vulnerable populations at national, subnational and local level are done for monitoring and targeting interventions (data flow, timeliness, representativeness optimal)",
              "runtimeType": "question"
            },
            {
            ...
            },
            {
              ...
              "level5":
                  "Descript, detect, monitor, raise awareness and provide insights, past trends and forecasting",
              "runtimeType": "question"
            },
            {
              "text":
              ...
              "level1": "No",
              "level2":
                  "No formal mechanism: Some facilities/units/teams encourage their HR for development but is not formalized and is based on individual commitment",
              "level3":
            ...
            },
            {
              ...
              "level1": "No",
              "level2":
                  "Some facilities/units/teams encourage their HR for development but is not formalized and is based on individual commitment",
              "level3":
            ...
            {
              "text":
                  "Tools::Health analysis and business intelligence tools are available for advanced approaches to health information. ",
              "level1":
                  "Basic tools are routinely used for health analysis (e.g., spreadsheets, MS Access, etc.)  ",
              "level2":
              ...
              "level4":
                  "Advanced tools are routinely used for health analysis (e.g., spreadsheets, statistical packages, etc.) and all data is stored in relational databases and new approaches for non traditional databases are initiated., tools are continuously updated and improved. Online data platform are available.",
              "level5":
            ...
            },
            {
              ...
              "level2": "Some facilities/units/teams do randomly",
              "level3":
                  "Some facilities/units/teams do as part of their routine.",
              "level4":
                  "Yes, is the standardized and interoperable health analysis tool used among public health system",
              "level5":
                  "Yes, is the standardized and interoperable health analysis tool used among the national health system",
              "runtimeType": "question"
            },
            {
            ...
            },
            {
              ...
              "level5":
                  "A national DWH is updated, sustainable, easy access, full documentation and data can be shared across national, subnational and local levels",
              "runtimeType": "question"
            },
            {
              "text":
                  "Organization disseminates data/information/analysis through ",
            ...
            {
              "text":
                  "Digital Health::Digital health tools being used to transform models of care, improve patient safety, quality of care and supporting population health approaches. Health care and service are delivered virtually.                                                                                                                                                                                                                     ",
              "level1":
                  "Health care delivery and services are largely manual processes. Assessing digital technologies in health incl health information systems at national/subnational level to identify areas of improvement",
              "level2":
            ...
            },
            {
              ...
              "level2":
                  "At the local level Digital Health initiatives are developed or adopted with no consideration of interoperability and IT standards issues. ",
              "level3":
                  "Starting to improve/plan a integrated digital health environment. Integration of local initiatives in progress.",
              "level4":
            ...
            {
              "text":
                  "Development of national digital health policy and strategies",
              "level1":
                  "The government plans specific digitalization actions, not focused on health, led by the technology ministry or the counterpart, such as ensuring connectivity with bandwidth according to the population size of the different places",
              "level2":
                  "The country has a digital strategy that does not include specific health actions led by the technology ministry or the counterpart.",
              "level3":
                  "The country has a specific digital strategy for health. The Ministry (authorities) of Health leads the digitalization of the health system, with actions such as the elaboration of plans for the implantation of EMR",
              "level4":
                  "The country has a specific digital health strategy with a multi-year budget",
              "level5":
                  "The country has a specific digital health strategy that is aligned with the general digital strategy and has a multi-year budget",
              "runtimeType": "question"
            },
            {
              "text":
                  "Telemedicine - patient to provider is a complement, not replacing person in person care",
              "level1": "not on the agenda",
              "level2":
                  "Some isolated initiatives at the local level, most based on reference and counter reference",
              "level3":
                  "Under development of a telemedicine network in the entire country",
              "level4":
                  "In process of implementation through all the institution",
            ...
            {
              "text":
                  "E-Government::Integration of the health sector on the eGovernment initiatives, including the adoption of standards, applications, and information services to transform transactions between government and the public, businesses, or other organizations in health. ",
              "level1": "E-government is not on the national agenda.",
              "level2":
                  "E-government is on the national agenda, but there is no formal strategy or unit in place.",
              "level3":
            ...
            {
              "text":
                  "E-government is on the national agenda (Citizens interaction with government)",
              "level1": "No",
              "level2":
            ...
            {
              "text":
                  "Level of integration of national health authorities in e-government initiatives",
            ...
            {
              "text":
                  "Integration of Health specific public portals or health e-service with the national e-government platform ",
              "level1": "No public e-services",
              "level2":
                  "Public health e-services are available, but separate from e-government platform and services",
              "level3":
                  "Some isolated public health e-services from facilities facilities/units/teams are integrated with national e-government platform",
              "level4":
                  "Yes, Public health e-services are  integrated but not with all sectors/stakeholders (correct statement?)",
              "level5":
                  "Yes, Public health e-services are fully integrated with national e-government platform (e.g. single point of entry; single sign-on)",
              "runtimeType": "question"
            },
            {
              "text":
                  "Open Government::Public access and effective oversight to government documents and proceedings. Open Data principles application and data sets availability. ",
              "level1":
                  "The concepts of Open Government are new to leadership.",
              "level2":
                  "There is broad knowledge of open government principles among national health authorities, and leadership support for advancing open government policies and initiatives.",
              "level3":
            ...
            },
            {
              ...
              "level1": "no",
              "level2":
                  "some policies/units/areas do as part of their institutional processes  ",
              "level3":
                  " Formal process under development in the entire organization",
              "level4": "Yes, documented and implemented at national levels",
              "level5":
                  "Yes,  documented and implemented at the facility, region and national levels",
              "runtimeType": "question"
            },
            {
              "text":
                  "Principles of “openness” integrated into organizational policy ",
              "level1": "No",
              "level2":
            ...
            {
              "text":
                  "Preparedness and Resilience::Capacity of the information systems for health to operate during and after emergencies and disasters requires the development and application of special operating procedures to ensure access to the right information at the right moment in the right format. ",
              "level1":
              ...
              "level5":
                  "Health information systems are  resilient during disasters and are able to able to support essential health system functions and disaster response",
              "runtimeType": "question"
            },
            {
